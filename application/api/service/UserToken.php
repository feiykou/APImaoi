...
class UserToken extends Token
{
   ...
   function __construct($code)
   {
    ...
    /*
     * 处理微信登录异常
     * 哪些异常应该返回客户端，哪些异常不应该返回客户端，需要认真思考
     */
     ...
     * 2、但旧令牌依然可以使用
     * 3、所以通常令牌的有效时间比较短
     * 4、目前微信的express_in时间是7200秒
     * 5、在不设置刷新新令牌(refresh_token)的情况下，只能延迟自有token的过期时间超过7200秒（目前无法确定，在express_in时间到期后还能否进行微信支付）
     * 6、没有刷新令牌会有一个问题，就是用户的操作有可能会被突然中断
     */
    private function grantToken($wxResult){
        /*
         * 1、此处生成令牌使用的是TP5自带的令牌
         * 2、如果想要更加安全可以考虑自己生成更复杂的令牌
         * 3、比如使用JWT并加入盐，如果不加入盐有一定的几率伪造令牌
